...
You can run the game right at your command line if you have `uv
<https://docs.astral.sh/uv/>`_ installed::
...
| 1.7 — 2024 November 9 — add an ``adventure`` console script so this package can be run with ``uvx adventure``.
